...
/**********************************************************************************************************/
export default function SuppliersFiltersPanel({ onSearch, onReset, onCreate }: FiltersPanelProps) {
            ...
            <div className="p-4">
                <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1 min-w-[300px]">
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="w-full py-2 pl-10 pr-4 text-sm text-gray-900 transition-all bg-white border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent placeholder:text-gray-400"
                            />
                        </div>
                    </div>
                    ...
                    <button
                        ...
                        className="px-4 py-2 text-sm font-medium text-white transition-colors rounded-lg bg-sky-600 hover:bg-sky-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
                    >
                        Поиск
                    </button>
