...
type TabType = 'materials' | 'movements' | 'writeOffAVR' | 'writeOffMPB';

const CONFIRMED_BY_SUPPLIER_STATUS = 2;
const ALL_PURCHASE_ORDERS_ID = 0;

/**********************************************************************************************************************/
export default function WarehousesTableвв({ data, refs, onEdit }: WarehousesTablePropsType) {
    ...
    const {
        data: writeOffAVR,
        pagination: paginationAVR,
        loading: loadingAVR,
    } = useAppSelector((state) => state.materialWriteOff);
                                                    ...
                                                    <div className="px-3 py-2 ml-8">
                                                        ...
                                                        {activeTab === 'writeOffMPB' && (
                                                            <div className="p-6 text-sm text-center text-gray-400 bg-white border rounded-lg">
                                                                Списание МПБ пока не реализовано
                                                            </div>
                                                        )}
                                                    </div>
                                                </Collapse>
