...
export default function MaterialEstimateItemFormRow({
    ...
    return (
        <PremiumTableRow hover>
            {/* 🎯 Drag handle (для будущего drag-and-drop) */}
            {/* <PremiumCell width={40} sx={{ cursor: 'grab' }}>
                <DragIndicator sx={{ color: 'action.disabled', fontSize: 18 }} />
            </PremiumCell> */}
            {/* Группа услуг */}
            <PremiumCell width={20}>
                <ReferenceSelect
                    label=""
            ...
            {/* Ед. изм (авто) */}
            <PremiumCell width={90} align="center">
                <Box
                    sx={{
                        px: 1.5,
                        py: 0.75,
