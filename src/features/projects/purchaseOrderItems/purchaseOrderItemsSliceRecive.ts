...
const purchaseOrderItemsReceiveSlice = createSlice({
...
export const { setPurchaseOrderItems, clearPurchaseOrderItems } =
    purchaseOrderItemsReceiveSlice.actions;

export default purchaseOrderItemsReceiveSlice.reducer;
