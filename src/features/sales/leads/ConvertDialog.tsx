...
import { ArrowRightLeft, Building2, Home, Layers3, X } from 'lucide-react';
...
export default function ConvertDialog({
    ...
    const floors = useMemo(() => {
        const floorsMap = new Map<number, { id: number; floor_number: number; name: string | null }>();
                ...
                <div className="space-y-5 px-6 py-5">
                    ...
                    <div className="flex flex-wrap items-center justify-end gap-3 border-t border-slate-100 pt-4">
                        ...
                        <button
                            ...
                            className="inline-flex h-10 items-center rounded-xl bg-emerald-600 px-5 text-sm font-medium text-white transition hover:bg-emerald-500 disabled:opacity-60"
                        >
