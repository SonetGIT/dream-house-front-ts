...
export default function UserCreateEditFrm(props: PropsType) {
    ...
    //                 <h6>{isEdit ? 'Редактирование пользователя' : 'Создание пользователя'}</h6>
    //             </div>

    //             <div className="detail-form-body">
    //                 <form onSubmit={handleSubmit(handleUpdate)} autoComplete="off" className=''>
    //                     {textFields.map((key) => (
    ...
    //                                             {...field}
    //                                             type={showPassword ? 'text' : 'password'}
    //                                             autoComplete="new-password" //отключает автозаполнение
    //                                             className={`form-input ${
    //                                                 'password' in errors ? 'is-invalid' : ''
    //                                             }`}
    //                                         />
