...
import { type PurchaseOrder } from '../projects/purchaseOrders/purchaseOrdersSlice';
...
/*************************************************************************************************************/
export default function WarehousePurchaseOrdersTable(props: PropsType) {
    ...
    //     // const warehouse_id = warehouseId; // или получите из контекста/состояния
    ...
    //                     toast.error(
    //                         `Укажите количество для "${props.getRefName.materialName(item.material_id)}"`
    //                     );
    //                     hasError = true;
    //                     return;
    //                 }
    ...
    //                     toast.error(
    //                         `Количество должно быть числом > 0 для "${props.getRefName.materialName(
    //                             item.material_id
    //                         )}"`
    //                     );
    //                     hasError = true;
                            ...
                            <React.Fragment key={req.id}>
                                ...
                                >
                                    ...
                                    <TableCell>
                                        Поставщик:
                                        <strong>
                                            {props.getRefName.suppliersName(req.supplier_id)}
                                        </strong>
                                    </TableCell>
                                    <TableCell>
                                        Статус:
                                                    ...
                                                    <TableBody>
                                                        {req.items?.map((item) => (
                                                            ...
                                                            >
                                                                ...
                                                                <TableCell>
                                                                    {props.getRefName.materialTypeName(
                                                                        item.material_type
                                                                    )}
                                                                </TableCell>
                                                                <TableCell>
